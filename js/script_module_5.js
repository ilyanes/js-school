...
// значениями которых должны быть переданные аргументы во время её вызова с
// оператором new.
...
// объявленные методы на геттеры и сеттеры brand, model и price для взаимодействия
// с приватными свойствами.
class Car {
  #model;
  #price;
  #brand;
...
// Метод должен проверять наличие значения параметра email в массиве хранящемся в
// свойстве blacklistedEmails и возвращать true или false.
